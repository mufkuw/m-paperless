...
DATE_REGEX = re.compile(r"(?i)\b((?:\d{2}|\d{4})(?:\s+)?[\.\-\/](?:\s+)?(?:\d{1,2})(?:\s+)?[\.\-\/](?:\s+)?(?:\d{2}|\d{4}))\b|\b((?:\d{1,2})(?:.+)?(?:jan\w+|feb\w+|mar\w+|apr\w+|may\w+|jun\w+|jul\w+|aug\w+|sep\w+|oct\w+|nov\w+|dec\w+)(?:.+)?(?:\d{4}))\b|\b((?:jan\w+|feb\w+|mar\w+|apr\w+|may\w+|jun\w+|jul\w+|aug\w+|sep\w+|oct\w+|nov\w+|dec\w+)(?:.+)?(?:\d{2})(?:.+)?(?:\d{4}))\b")
